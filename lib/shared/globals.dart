...
class FireBase {
  ...
  replys(){
    return FirebaseFirestore.instance.collection('replys');
  }
  ...
  workerComplains() {
    return FirebaseFirestore.instance.collection('workerComplains');
  }

  customerComplains() {
    return FirebaseFirestore.instance.collection('customerComplains');
  }

  customer() {
    return FirebaseFirestore.instance.collection('customer');
  }
